...
public class StreamActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<HashMap<String,String>> stream_list = (ArrayList<HashMap<String, String>>) reciever.getSerializableExtra("streamList");
    ...
    // iterator to iterate throught the items in the area obtained by the podcast organizer class
        ...
        for (int a =0; a<stream_list.size();a++){
            for(int b=a+1; b<stream_list.size();b++){
                ...
                for (HashMap<String, String> hm : stream_list){
                    ...
                    String value = hm.get("podcastName");
        ...
        adapter = new ArrayAdapter<String>(this, R.layout.dynamic_content, listItems);
