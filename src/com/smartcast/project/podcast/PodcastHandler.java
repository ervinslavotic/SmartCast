 ...
 * Making sure that the podcast to be streamed is of a valid format 
 */
...
public class PodcastHandler extends DefaultHandler {
    ...
    public PodcastHandler(DownloadHistory history, Boolean priority) {
        this.history = history;
        this.priority = priority;
    }

    public PodcastHandler(DownloadHistory history) {
        this(history, false);
    }
