...
public class Util {
    ...
    public static void findAvailablePodcasts(String url, PodcastHandler encloseureHandler) throws Exception {
    ...
    // shared with SubscriptionEdit
    public static void downloadPodcast(String url, PodcastHandler encloseureHandler) throws Exception {
